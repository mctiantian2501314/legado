...
import com.eggreader.app.help.storage.BackupConfig
import com.eggreader.app.help.storage.ImportOldData
import com.eggreader.app.help.storage.Restore
...
import com.eggreader.app.utils.toEditable
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<com.eggreader.app.lib.prefs.Preference>("web_dav_restore")
            ?.onLongClick {
                restoreFromLocal()
                true
            }
