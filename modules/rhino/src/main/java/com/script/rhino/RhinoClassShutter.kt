...
object RhinoClassShutter : ClassShutter {
    ...
    private val protectedClassNamesMatcher by lazy {
        listOf(
            ...
            "com.eggreader.app.data.AppDatabase",
            "com.eggreader.app.data.AppDatabase_Impl",
            "com.eggreader.app.data.AppDatabaseKt",
            "com.eggreader.app.utils.ContextExtensionsKt",
